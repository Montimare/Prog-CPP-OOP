...
void kapitel1(Held& h1, Held& h2, Held& h3)
{
	...
	cout << " ist und ich " << h1.get_alter() << " Jahre alt bin, " << "ausserdem bin ich " << h1.get_groesse() /100 << "m gross" << endl;
	cout << endl;
	...
	cout << " und ich bin wohl " << h2.get_alter() << " Jahre alt und " << h2.get_groesse() /100 << "m gross" << endl;
	cout << endl;
	...
	cout << endl;
	cout << "AH! Moment ich bin " << h3.get_groesse() /100 << "m gross" << endl << endl;
	cout << endl;
